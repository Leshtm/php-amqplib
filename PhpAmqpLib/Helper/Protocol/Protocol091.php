...
class Protocol091
{
     ...
     * @return array
     */
    public function connectionStart($version_major = 0, $version_minor = 9, $server_properties = 0, $mechanisms = 'PLAIN', $locales = 'en_US')
    {
     ...
     * @return array
     */
    public function connectionClose($reply_code, $reply_text = '', $class_id = 0, $method_id = 0)
    {
        $writer = new AMQPWriter();
     ...
     * @return array
     */
    public function channelClose($reply_code, $reply_text = '', $class_id = 0, $method_id = 0)
    {
        $writer = new AMQPWriter();
        $writer->write_short($reply_code);
        $writer->write_shortstr($reply_text);
